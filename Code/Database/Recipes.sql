...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Máj 04. 21:48
...
CREATE TABLE `recipes` (
  ...
  `freefrom_name` varchar(255) DEFAULT NULL,
  `ingredients_name` char(255) DEFAULT NULL,
...
--
ALTER TABLE `ingredients`
  ADD CONSTRAINT `Constrait_RECING_FK` FOREIGN KEY (`ingredients_id`) REFERENCES `recipe_ingredients` (`ingredients_id`),
  ADD CONSTRAINT `Constrait_Recipes_FK` FOREIGN KEY (`ingredients_id`) REFERENCES `recipes` (`ingredients_name`);

--
-- Megkötések a táblához `recipes`
--
ALTER TABLE `recipes`
  ADD CONSTRAINT `Constrait_RecipesFF_FK` FOREIGN KEY (`recipes_id`) REFERENCES `recipe_freefrom` (`recipe_id`),
  ADD CONSTRAINT `recipes_ibfk_1` FOREIGN KEY (`ingredients_name`) REFERENCES `ingredients` (`ingredients_id`);
